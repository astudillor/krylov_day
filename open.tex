...
\begin{tikzpicture}[overlay]
 \node at (1,-1) [rotate=10] {\includegraphics[width=.18\textwidth]{pics/K1.png}};
 \node at (2.5,-1.5) [rotate=-2] {\includegraphics[width=.18\textwidth]{pics/K1.png}};
 \node at (4,-1) [rotate=15] {\includegraphics[width=.18\textwidth]{pics/K1.png}};
 
 \node at (9,0) [rotate=-5]{\includegraphics[width=.18\textwidth]{pics/K1.png}};
 
 \node at (0.3,3) [rotate=15]{\includegraphics[width=.18\textwidth]{pics/K1.png}};
 \node at (1,3) [rotate=-5]{\includegraphics[width=.18\textwidth]{pics/K1.png}};
...
\frametitle{Let's welcome Peter Sonneveld}
 \begin{columns}
 \begin{column}{0.6\textwidth}
 Peter's work has huge impact on research in Krylov method.
 \begin{itemize}
  \item IDR [1980]
  \item CGS [1989]
  \item IDR(s) [2006]
