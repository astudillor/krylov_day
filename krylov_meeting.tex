...
\vspace{-1.5cm}
\begin{figure}[h]
 \includegraphics[width=0.3\textwidth]{Society_for_Industrial_and_Applied_Mathematics_(logo).png} \hfill
 \includegraphics[width=0.3\textwidth]{TU_d_line_P1_color-TU-Delft.png} \hfill
 \includegraphics[width=0.3\textwidth]{SIAMSC_Delft.png}
\end{figure}
\\
